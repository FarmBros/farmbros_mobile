                          ...
                          onTap: () {
                            context.push(
                                ...
                                extra: {
                                  ...
                                  "farm_boundary": extra["farm"]["boundary"],
                      ...
                      if (selectedType != null && fieldsToShow.isNotEmpty) ...[
                        ...
                        Column(
                          children: fieldsToShow.map((field) {
                            if (!dynamicFieldControllers.containsKey(field)) {
                      ...
                      FarmbrosButton(
                        ...
                        onPressed: () {
                          ...
                          context.read<PlotStateCubit>().execute(
                              PlotDetailsParams(
                                  name:
                                      controllers[CreatePlotInputType.plotName]!
                                          .text,
                                  farmId: extra!["farm"]["uuid"],
                                  notes: controllers[CreatePlotInputType.notes]!
                                      .text,
